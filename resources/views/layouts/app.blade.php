...
<head>
    ...
    <title>{{ config('app.name', 'KWAK') }}</title>
...
<body>
<div id="app">
    <nav class="navbar navbar-expand-md nav-tabs navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                {{ config('app.name', 'KWAK') }}
                <img src="/img/duck.png" alt="" style="width: 15px; height:15px;">
            </a>
